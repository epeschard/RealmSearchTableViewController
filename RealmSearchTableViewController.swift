...
class RealmSearchTableViewController <entity: CustomClass, cell: CustomCell> : UITableViewController,
    ...
    typealias ResultVC = RealmResultTableViewController
    typealias DetailVC = RealmDetailViewController
